...
public class SendEmail {
    ...
    public static String myEmailAccount = "sanli84lu@gmail.com";
    public static String myEmailPassword = "lu020806";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "1808708079@qq.com";
